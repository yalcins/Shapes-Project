 ...
 */
 ...
 // create second student object with your constructor
and print out info
 // End of problem 1
 }
 ...
 */
 ...
 // call your object's getType() method here and store
 ...
 */
 ...
 // set the variable to a random number between 100
and 200
 // create a new variable and set it to the square of the
original using your method
 // print out both the original number and the square
of int
 // *** OPTIONAL *** Implement your own square root
method ***
 // *** not extra credit, just fun and challening ***
 // *** only do this part if you are done all the others
***
 // *** Step 1: use a built-in method from the Math
class ***
 ...
 */
 ...
 System.out.println("Please enter your first name and
last name separated by a space:");
 String fullName = s.nextLine(); // Read the user input
